package com.danlu.auth.service;

import com.danlu.auth.config.AuthProperties;
import com.danlu.auth.domain.PersistentToken;
import com.danlu.auth.repository.PersistentTokenRepository;
import com.danlu.auth.repository.UserRepository;
import com.danlu.auth.util.RandomUtil;
...
public class PersistentTokenRememberMeServices extends
    ...
    public PersistentTokenRememberMeServices(AuthProperties authProperties,
                                             org.springframework.security.core.userdetails.UserDetailsService userDetailsService,
                                             PersistentTokenRepository persistentTokenRepository, UserRepository userRepository) {

        super(authProperties.getSecurity().getRememberMe().getKey(), userDetailsService);
